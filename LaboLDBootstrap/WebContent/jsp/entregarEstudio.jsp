		...
		<td>
			<div class="well-sm-bootstrap well-bootstrap">	
				...
				<table border="0" class="cuadradoSinBordeBootstrapSinFont" align="center" width="100%" cellpadding="2" cellspacing="0">
					<tr>
						<td colspan="4"  class="tituloTabla" >Entregar Estudio</td>
					</tr>
					<tr>
		...
		<tr>
			<td align="center">
				...
				<c:if test="${estudio.estadoStr != 'Entregado'}">			
					<input type="button" class="btn btn-primary-bootstrap btn-sm" value="Entregar Estudio" onclick="javascript:entregarEstudio();">
				</c:if>					
...
<html:form action="estudio" styleId="estudioFormId">
	...
	<tr>
		<td>
			<div class="well-sm-bootstrap well-bootstrap">	
				...
				<table border="0" class="cuadradoSinBordeBootstrapSinFont" align="center" width="100%" cellpadding="2" cellspacing="0">
					<tr>
						<td colspan="6"  class="tituloTablaBoots" >Entregar Estudio</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width="20%">			
							<input type="text" value="${estudio.paciente.apellido}, ${estudio.paciente.nombre}" class="form-control form-control-sm" size="30" readonly="readonly"/>
						</td>
						<td width="5%"></td>									
					</tr>						
					<tr>
						...
						<td width="25%">			
							<input type="text" value="${estudio.medico.descripcion}" class="form-control form-control-sm" size="30" readonly="readonly"/>
						</td>	
						<td width="5%"></td>
					...
					<tr>		
						...
						<td width="25%">			
							<input type="text" value="${estudio.estadoStr}" class="form-control form-control-sm" size="30" readonly="readonly"/>
						</td>
						<td width="5%"></td>
	...
	<table border="0" class="cuadradoSinBorde" align="center" width="70%" cellpadding="2" cellspacing="0">
		...
		<tr>
			<td width="35%"></td>			
			<c:choose>
				<c:when test="${estudio.estadoStr != 'Entregado'}">
					<td width="15%">
						<input type="button" class="btn btn-block btn-outline-primary" value="Entregar Estudio" onclick="javascript:entregarEstudio">
					</td>	
					<td width="15%">	
